    ...
    <div className='min-h-screen bg-background flex flex-col'>
      <header className='bg-white shadow-sm'>
        <div className='max-w-xl mx-auto px-4 py-3'>
          <h1 className='text-headerColor text-2xl font-bold'>Bruno Dev Translate</h1>
      ...
      <main className='flex-grow flex flex items-start justify-center px-4 py-8'>
        <div className='w-full max-w-5xl bg-white rounded-lg shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-200'>
            ...
            <button className='p-2 rounded-full hover:bg-gray-100 outline-non' onClick={swapTranslate}>
              <svg
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div className='p-4 relative bg-secondaryBackground border-l border-gray-300'>

              {isLoading ? (
                <div className='absolute inset-0 flex items-center justify-center'>
                  <div className='animate-spin rounded-full h-8 w-8 border-t-2 border-blue-500 relative'></div>
                </div>
              ) : (
          ...
          {error && (
            ...
            <div className='p-4 bg-red-200 border-t border-red-500 text-red-800'>
              {error}
            </div>
      ...
      <footer className='bg-white border-t border-gray-200 mt-auto'>
        <div className='max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor'>
          &copy; {new Date().getFullYear()} Desenvolvido por Bruno Chaves
        </div>
      </footer>
